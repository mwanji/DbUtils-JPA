...
DbUtils-JPA currently relies on "my fork of DbUtils":https://github.com/mwanji/DbUtils to insert records. This will change when this feature is integrated into the released version of DbUtils. Please clone and <code>mvn install</code> that library.
...
* "SqlWriter":https://github.com/mwanji/DbUtils-JPA/blob/master/src/main/java/com/moandjiezana/dbutilsjpa/SqlWriter.java generates SQL based on the annotations.
...
JpaBeanProcessor can be used apart from JpaQueryRunner, in conjunction with a RowProcessor and a ResultSetHandler, just like any other "BeanProcessor":http://commons.apache.org/dbutils/apidocs/org/apache/commons/dbutils/RowProcessor.html, to use JPA mappings in cases not handled by JpaQueryRunner.
